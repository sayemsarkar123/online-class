...
const CartCourses = (props) => {
  const { title, price, headline, image_750x422 } = props.course;
  return (
    <div className="p-3">
      <div className="row">
        ...
        <div className="col-md-2 text-right">
          <h6 style={{fontSize: '14px', color: '#00adb5'}}>Remove</h6>
          <h6 style={{fontSize: '14px', color: '#00adb5'}}>Save for Later</h6>
          <h6 style={{fontSize: '14px', color: '#00adb5'}}>Move to Wishlist</h6>
        </div>
        <div className="col-md-2">
